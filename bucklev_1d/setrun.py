...
#------------------------------
    ...
    probdata.add_param('ur',  ur, 'Right state')
    probdata.add_param('ul',  ul, 'Left state')
    probdata.add_param('a',    a, 'Flux parameter')
    ...
    clawdata.upper[0] =  1.500000e+00          # xupper
    
    # Number of grid cells:
    clawdata.num_cells[0] = 150       # mx
