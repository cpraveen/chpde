...
#------------------------------
    ...
    u1, u2 = 2.0, 1.0
    # Initial density
    rho1, rho2 = 0.3333, 0.1

    #------------------------------------------------------------------
    # Problem-specific parameters to be written to setprob.data:
    #------------------------------------------------------------------
    probdata = rundata.new_UserData(name='probdata', fname='setprob.data')
    probdata.add_param('u1',  u1,  'left advection velocity')
    probdata.add_param('u2',  u2,  'right advection velocity')
    probdata.add_param('rho1',  rho1,  'left density')
    probdata.add_param('rho2',  rho2,  'right density')
    ...
    clawdata.lower[0] = -4.500000e+01          # xlower
    clawdata.upper[0] =  4.500000e+01          # xupper
