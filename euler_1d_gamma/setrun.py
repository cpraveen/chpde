...
#------------------------------
    ...
    probdata.add_param('rhol',   rhol,    'rhol')
    probdata.add_param('rhor',   rhor,    'rhor')
    probdata.add_param('vl',     vl,      'vl')
    probdata.add_param('vr',     vr,      'vr')
    probdata.add_param('pl',     pl,      'pl')
    probdata.add_param('pr',     pr,      'pr')
    probdata.add_param('gammal', gammal,  'gammal')
    probdata.add_param('gammar', gammar,  'gammar')
