...
#------------------------------
    ...
    beta  = 5.0
    L     = 5.0
    tfinal= sqrt(2.0) * (2 * L) / mach
    probdata = rundata.new_UserData(name='probdata',fname='setprob.data')
    probdata.add_param('gamma',     1.4,  'gamma - ratio of specific heats')
    probdata.add_param('mach',     mach,  'mach  - Mach number')
    probdata.add_param('alpha',   alpha,  'alpha - flow angle')
    probdata.add_param('beta',     beta,  'beta  - vortex strength')
    ...
    clawdata.lower[0] = -L                     # xlower
    clawdata.upper[0] =  L                     # xupper
    clawdata.lower[1] = -L                     # ylower
    clawdata.upper[1] =  L                     # yupper
    ...
    gauges.append([1,0.0,0.0,0.0,1e9])
